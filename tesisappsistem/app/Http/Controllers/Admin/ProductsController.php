        ...
        if($request->isMethod('post')){
            ...
            if ($request->hasFile('producto_image')) {
                ...
                if ($image->isValid()) {
                    ...
                    // Mueve la imagen a la primera ruta especificada
                    $image->move(public_path('front/images/product_images/original'), $imageName);
            
                    // Copia la imagen a las otras rutas
                    copy(public_path('front/images/product_images/original/' . $imageName), $largeImagePath);
                    copy(public_path('front/images/product_images/original/' . $imageName), $mediumImagePath);
                    copy(public_path('front/images/product_images/original/' . $imageName), $smallImagePath);
        ...
        if($request->hasFile('producto_video')){
            ...
            foreach($productFilters as $filter){
                ...
                if($filterAvailable=="Si"){
                    if(isset($filter['filtro_columna']) && $data[$filter['filtro_columna']]){
