...
<head>
    ...
    <title>@if(!empty($meta_titulo)){{ $meta_titulo }} @else Laravel Multi Vendedor E-commerce @endif</title>
    @if(!empty($meta_descripcion))<meta name="descripcion" content="{{ $meta_descripcion }}">@endif

    @if(!empty($meta_palabraclave))<meta name="keywords" content="{{ $meta_palabraclave }}">@endif
    <!-- Standard Favicon -->
...
<div class="loader">
   <img src="{{ asset('front/images/loaders/lg.gif') }}" alt="loading..." />
</div>
